...
user in an INI file next to Capture2TextPortable.exe called Capture2TextPortable.ini.
...
copy AppNamePortable.ini from this directory to Capture2TextPortable.ini next to
Capture2TextPortable.exe. The options in the INI file are as follows:
