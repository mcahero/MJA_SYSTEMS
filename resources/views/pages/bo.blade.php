                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <div class="text-center"
                                    ...
                                    <p id="display_balance_pcs" class="mb-0"
                                        style="font-size: 24px; font-weight: bold; line-height: 80px;">0</p>
                                    <b class="mb-0" style="font-size: 12px; color: #6c757d;">Display</b>
                                </div>
                    ...
                    success: function(response) {
                        ...
                        $('#sku_id').off('change').on('change', function() {
                            ...
                            if (selectedProduct) {
                                ...
                                $('#display_balance_pcs').text(selectedProduct
                                    .display_balance_pcs);
                            } else {
                                $('#product_name').val('');
                                $('#selected_sku').val('');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#sku_id').on('change', function() {
                            ...
                            if (selectedProduct) {
                                let display_balance_pcs = selectedProduct.pcs;
                                $('#display_balance_pcs').text(display_balance_pcs);
                            } else {
                                $('#display_balance_pcs').text('N/A');
                            }
                    ...
                    error: function(xhr, status, error) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error!',
                                text: 'Insufficient PCS in Display.',
                            });
                        }
                    }
